...
app.layout = html.Div([
        ...
        html.Div(["Mileage", dbc.Input(id = "mileage", min = 0, type = 'number', placeholder ="Please Enter Here"),
        dbc.FormText("Please do not put nagative numbers.",color="secondary"), html.Br()]),
        html.Div(["Kilometers driven", dbc.Input(id = "km_driven", type = 'number', min = 0, placeholder="Please Enter Here"),
        dbc.FormText("Please do not put nagative numbers.",color="secondary"), html.Br()]),
