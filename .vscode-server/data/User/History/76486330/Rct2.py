...
app.layout = html.Div([
        ...
        html.Br(),
        html.H6("You can estimate the cars cost by entering values into the parameters. The three interdependent features for predicting car prices include Maximum power, Mileage, and Kilometers driven"),
