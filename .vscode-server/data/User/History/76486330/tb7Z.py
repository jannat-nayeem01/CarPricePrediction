...
app.layout = html.Div([
        html.Br(),
        html.H3("Welcome to Car Price Prediction Website"),
        html.Br(),
        html.H6("Please estimate the cars cost by entering three interdependent features include Maximum power, Mileage, and Kilometers driven"),
        html.H6("Please try to give at lease one input."),
        html.H6("Please Find your Car Price after Click the Submit Button."),
        html.Br(),
        html.H4("Definition:"),
        html.Br(),
        html.H6("Maximum power: Maximum power of a car(bhp)"),
        ...
        html.Br(),
        html.Div(["Put a value for max_power",dbc.Input(id = "max_power", type = 'number', min = 0, placeholder="Please Enter Here"),
        dbc.FormText("Please do not put nagative numbers.",color="secondary"), html.Br()]),
        html.Div(["Put a value for mileage", dbc.Input(id = "mileage", min = 0, type = 'number', placeholder ="Please Enter Here"),
        dbc.FormText("Please do not put nagative numbers.",color="secondary"), html.Br()]),
        html.Div(["Put a value for km_driven", dbc.Input(id = "km_driven", type = 'number', min = 0, placeholder="Please Enter Here"),
        dbc.FormText("Please do not put nagative numbers.",color="secondary"), html.Br()]),
        dbc.Button(id="submit", children="submit", color="dark", className="me-1"),
...
def prediction (max_power, mileage, km_driven, submit):
    ...
    return f"Predictive Car Price: {round(result[0],2)}"
